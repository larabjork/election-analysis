...
total_votes = 0
# Initialize a list for candidate names and dictionary for candidate votes
candidate_options = []
candidate_votes = {}
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        # Retrieve vote count of a candidate and percentage and print outcome in terminal
    ...
    # Print results for winning candidate to terminal
